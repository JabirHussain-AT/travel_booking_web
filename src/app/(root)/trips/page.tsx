...
const TripDetailsContent = () => {
  ...
  const displayPrice =
    selectedPackages.length > 0 ? totalPrice : tripData?.startingPrice || 0;
          ...
          <div className="flex-1">
            ...
            {tripData.packages && tripData.packages.length > 0 && (
              <div className="px-4 sm:px-6 mb-5 mt-8 relative">
                ...
                <PackagesSection
                  packages={tripData.packages.map(
            ...
            {tripData.additionalDetails &&
              tripData.additionalDetails.length > 0 &&
              (() => {
                const validDetails = tripData.additionalDetails.filter(
                  (detail: any) => {
            ...
            <div ref={bookingRef} className="md:hidden">
              <BookingSidebar
                ...
                savings={
                  savings > 0 && selectedPackages.length === 0
                    ? `${formatPrice(savings)}/-`
                    : ""
                }
                isPackage={true}
            ...
            <div className="px-4 sm:px-6 mb-5">
              {tripData && (
                <ReviewsSection
                  itemId={
                    tripData._id?.toString() || tripData.id || tripId || ""
                  }
                  itemType="trip"
                />
              )}
