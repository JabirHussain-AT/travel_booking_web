...
const ListCarousel = dynamic(() => import("@/components/ListDetails/ListCarousel"), {
  loading: () => <div className="h-[70vh] sm:h-[90vh] bg-gray-200 animate-pulse rounded-sm sm:rounded-3xl" />,
});

const ReviewsSection = dynamic(() => import("@/components/ListDetails/ReviewsSection"), {
  loading: () => <div className="h-64 bg-gray-100 animate-pulse rounded-lg" />,
});

const PackagesSection = dynamic(() => import("@/components/ListDetails/PackagesSection"), {
  loading: () => <div className="h-64 bg-gray-100 animate-pulse rounded-lg" />,
});

const BookingSidebar = dynamic(() => import("@/components/ListDetails/ListingDetailsClient"), {
